...
/**
 * Classe responsable de la cr̩ation des groupes GitLab selon le LDAP.
 *
 * @implNote Cette classe ne supprime PAS les groupes si pas trouv̩s dans LDAP.
...
public class ImportGroupsFromLDAP implements Mission {
	...
	/**
	 * Cr̩e les groupes dans GitLab.
	 *
	 * @implNote Le/s groupe/s consid̩r̩s comme admins n'auront pas de groupe cr̩̩.
	 */
	@Override
